      ...
      <div class="modal-body">
        <div class="container">
          ...
          <form id="addUserform" method="post">
            ...
            <div class="form-group">
              <label>Credit</label>
              <input type="number" class="form-control" placeholder="Amount Credit" name="addCredit" value="0" pattern="^[a-zA-Z0-9_.-]+$" autocomplete="off" required>
            </div>
          <!--  <div class="form-group">
