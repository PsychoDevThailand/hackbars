    ...
    <div class="container-fluid">
      ...
      <div class="container">
        ...
        <div style="float:right;margin-bottom:5px;">
          <div class="input-group">
            <button id="usersbtn" type="button" class="btn btn-success" style="margin-right: 1em"><i class="fas fa-user"></i> Users</button>
            <?php if ($_SESSION["Permit"] == '99'): ?>
              <button id="adminbtn" type="button" class="btn btn-outline-primary" style="margin-right: 1em"><i class="fas fa-user-secret"></i> Admin</button>
            <?php endif; ?>
      ...
      success: function(data) {
        ...
        if (data != "error") {
          ...
          $.each(res, function(key, value) {
            ...
            switch (value['type']) {
              case '90':
                html += '<span style="color: #0275d8">Admin<span>';
                break;
              case '99':
                html += '<span style="color: #d9534f">Super<span>';
                break;
              default:
                html += '<span style="color: #5cb85c">User<span>';
                break;
            }
            html += '</td>';
