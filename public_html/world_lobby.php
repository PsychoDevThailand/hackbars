<?php require 'database/session.php';
  require 'database/api_world_status.php';
...
<head>
  ...
  <script type="text/javascript" src="./js/world_lobby.js?v=<?=$v ?>"></script>
...
<?php
  // print_r($world_data->{'data'});
  // echo count($world_data->{'data'});
       // $room = "C";
       // $J = "0";
for ($i=0; $i < count($world_data->{'data'}) ; $i++) {
    // print_r($world_data->{'data'}[$i]->{'table_name'});
    if (($i%2) == 0) {
        echo '<div class="row">';
    }
    if (($i) == count($world_data->{'data'}));
    {
            ...
            <?php endif; ?>>
              <div class="row resroom" style="padding:2%;border-radius:15px;
                ...
                <div class="col" style="height: 100%;
                        ...
                        padding-right:4% ">
                  <span class="txtroom">ROOM : <?php echo $world_data->{'data'}[$i]->{'room_name'}; ?></span>
                </div>
