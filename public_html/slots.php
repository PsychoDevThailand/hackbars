      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-12 col-sm-6 game_colum">
            <a
              <?php if ($_SESSION['Credit'] >= 20): ?>
                href="database/slot_gateway.php?slot=spinomenal"
              <?php else: ?>
                href="#" onclick="Swal.fire({ type: 'error',title: 'คุณมี Credit ไม่พอใช้บริการนี้',text: 'กรุณาเติมเงินก่อนเข้าใช้งานต่อไปค่ะ'})"
              <?php endif; ?>
            >
              <div class="game_div">
                <img src="resource/images/cas/Game-spinomenal.png" style="width: 100%;">
              </div>
            </a>
          </div>
          ...
          <div class="col-12 col-sm-6 game_colum">
            <a
              <?php if ($_SESSION['Credit'] >= 20): ?>
                href="database/slot_gateway.php?slot=gtm"
              <?php else: ?>
                href="#" onclick="Swal.fire({ type: 'error',title: 'คุณมี Credit ไม่พอใช้บริการนี้',text: 'กรุณาเติมเงินก่อนเข้าใช้งานต่อไปค่ะ'})"
              <?php endif; ?>
            >
              <div class="game_div">
                <img src="resource/images/cas/Game-gtm.png" style="width: 100%;">
              </div>
            </a>
          </div>
          ...
          <div class="col-12 col-sm-6 game_colum">
            <a
              <?php if ($_SESSION['Credit'] >= 20): ?>
                href="database/slot_gateway.php?slot=tomhorn"
              <?php else: ?>
                href="#" onclick="Swal.fire({ type: 'error',title: 'คุณมี Credit ไม่พอใช้บริการนี้',text: 'กรุณาเติมเงินก่อนเข้าใช้งานต่อไปค่ะ'})"
              <?php endif; ?>
            >
              <div class="game_div">
                <img src="resource/images/cas/Game-tomhorn.png" style="width: 100%;">
              </div>
            </a>
          </div>
          ...
          <div class="col-12 col-sm-6 game_colum">
            <a
              <?php if ($_SESSION['Credit'] >= 20): ?>
                href="database/slot_gateway.php?slot=party"
              <?php else: ?>
                href="#" onclick="Swal.fire({ type: 'error',title: 'คุณมี Credit ไม่พอใช้บริการนี้',text: 'กรุณาเติมเงินก่อนเข้าใช้งานต่อไปค่ะ'})"
              <?php endif; ?>
            >
              <div class="game_div">
                <img src="resource/images/cas/Game-party.png" style="width: 100%;">
              </div>
            </a>
          </div>
          ...
          <div class="col-12 col-sm-6 game_colum">
            <a
              <?php if ($_SESSION['Credit'] >= 20): ?>
                href="database/slot_gateway.php?slot=pg"
              <?php else: ?>
                href="#" onclick="Swal.fire({ type: 'error',title: 'คุณมี Credit ไม่พอใช้บริการนี้',text: 'กรุณาเติมเงินก่อนเข้าใช้งานต่อไปค่ะ'})"
              <?php endif; ?>
            >
              <div class="game_div">
                <img src="resource/images/cas/Game-pg.png" style="width: 100%;">
              </div>
            </a>
          </div>
        ...
        <div class="alert alert-light" role="alert">
          ...
          <hr>
          <p> พิเศษสำหรับลูกค้า SPY777 เพียงท่านฝากเงินสำหรับเล่นเกมกับ SPY777 ก็สามารถรับเครดิตใช้งานสูตรฟรี! ทันที</p>
          ...
          <p class='text-danger'><strong>*หมายเหตุ* เครดิตของสูตรบาคาร่าจะเข้าภายใน 5 นาทีหลังจากได้รับเครดิต SPY777</strong></p>
        </div>
        <?php else: ?>
          <div class="alert alert-light" role="alert">
            <h4 class="alert-heading text-info">วิธีรับเครดิตฟรี</h4>
            <hr>
            <p>เครดิตหมดใช่หรือไม่ ? พิเศษหากท่านต้องการเครดิตสำหรับสูตรบาคาร่า เพียงท่านสมัครเล่นเกมกับเรา SPY777 เพียงเติมเงินครั้งแรก เติมเท่าไหร่ได้รับเครดิตสำหรับสูตรบาคาร่า 2 เท่า ของยอดเติมทันที (เฉพาะครั้งแรก) สมัครเลย คลิ๊ก!
