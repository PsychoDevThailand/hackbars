...
if ($_GET['id'] < 1 or $_GET['id'] > 23) {
    header('location: lobby.php');
    exit();
}

if ($_GET['id'] == 4 or $_GET['id'] == 14) {
    header('localtion: lobby.php');
    exit();
}
...
<body style="background-image: url('resource/images/new/<?php echo $asset_path ?>/BG.png');">
  ...
  <script type="text/javascript" src="./js/wm_room.js?v=<?=$v ?>"></script>
            ...
            <div class="container frameA" style="background-image: url('resource/images/new/<?php echo $asset_path ?>/FrameD.png'), url('resource/images/new/<?php echo $asset_path ?>/FrameA-2.png');">
              <div class="row">
                <div class="col-auto pr-0">
                  <h1 style="margin-bottom: -8px;font-size:32px"><img height="60" src="resource/images/new/WMgaming.png"> <?php echo str_pad(intval($_GET['id']), 3, '0', STR_PAD_LEFT); ?></h1>
                </div>
