      ...
      // }?>
          ...
          <div class="m-1">
            <a <?php if ($_SESSION['Credit'] > 0): ?>
              href="wmroom?id=<?php echo $rooms[$i]+1; ?>"
            <?php else : ?>
            ...
            <?php endif; ?>>
              <div class="row resroom" style="padding:2%;border-radius:15px;
                ...
                <div class="col" style="height: 100%;
                        background-image: url('resource/images/new/WMgaming.png');
                        background-repeat: no-repeat;
                        background-size: 70% 70%;
                        background-position: center top;
                        padding-right:4% ">
				  <span class="txtroom">TABLE : <?php echo str_pad($rooms[$i]+1, 3, '0', STR_PAD_LEFT); ?></span></div>
                <div class="col-6 col-md-5 text-center" style="background-image: url('resource/images/new/tb_line.png');
                  ...
                  <span id='<?php echo "winrate".$rooms[$i] ?>' class="showtext" style="color: khaki;">รอผล</span>
                </div>
              </div>
            </a>
          </div>
