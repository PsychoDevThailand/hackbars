...
<head>
  ...
  <title>Botz.in.th | โปรแกรมโกงสูตรบาคาร่า Ai แฮกบาคาร่า | Lobby : Baccarat</title>
  ...
  <script type="text/javascript" src="./js/se_lobby.js?v=<?=$v ?>"></script>
            ...
            <?php endif;  ?>>
              <div class="row resroom" style="padding:2%;border-radius:15px;
                ...
                <div class="col" style="height: 100%;
                        background-image: url('resource/images/new/SexyBaccarat.png');
